...
bool CNtlStorageUnit::Create( eNTL_STORAGE_TYPE eType )
{
	...
	case eNTL_STORAGE_CHAT:
		...
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_CHAT_BASIC_EMOTE);
		...
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_CHAT_EXTEND_EMOTE);
		...
		INSERT_DEFAULT_VALUE(m_mapStorageData, dSTORAGE_CHAT_EXTEND2_EMOTE);
...
bool CNtlStorageUnit::Reset()
{
	...
	case eNTL_STORAGE_CHAT:
		...
		CHANGE_RESET_VALUE(dSTORAGE_CHAT_BASIC_EMOTE);
		...
		CHANGE_RESET_VALUE(dSTORAGE_CHAT_EXTEND_EMOTE);
		...
		CHANGE_RESET_VALUE(dSTORAGE_CHAT_EXTEND2_EMOTE);
